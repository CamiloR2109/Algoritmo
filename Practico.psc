...
//5.Año bisiesto: Solicita al usuario un año y determina si es un año bisiesto o no. Un año bisiesto es divisible para 4, pero no por 100, a menos que tambien sea divisible para 400.
...
Funcion CalculoBonoAntiguedad
    Definir años_trabajados, salario, bono Como Real
    
    Escribir "Ingrese la cantidad de años trabajados: "
    ...
    Escribir "El bono de antigüedad es: $", ConvertirATexto(bono)
FinFuncion
...
Funcion CalcularDistancia14
	...
	Si distancia >= 50 Entonces
		costo=20
	FinSi
	Escribir "El costo de envío es: $" , ConvertirATexto(costo)
FinFuncion
...
Funcion CalcularCosto
    ...
    // Calcular el descuento según el número de unidades
...
Funcion GananciaUvas
    ...
    Definir Tamaño, PrecioInicial, Ganancia, IVA Como Real
	
    // Leer el tipo de uva y tamaño
    ...
    // Calcular la ganancia según el tipo y tamaño
...
Funcion CostoViaje
    ...
    // Determinar el costo por alumno y la renta del autobús
...
Funcion TresTiposDeBuses
    ...
    // Determinación del costo por kilómetro según el tipo de autobús
	...
	// Verificar si hay menos de 20 personas y ajustar el número de personas
    ...
    Sino
        ...
        Sino
            ...
            Sino
                ...
                Sino
                    Escribir "El carácter no pertenece a ninguna de las categorías."
                FinSi
            FinSi
        FinSi
    FinSi
